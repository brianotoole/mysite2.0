...
function brianzotoole2_0_setup() {
	 ...
	 * If you're building a theme based on brianzotoole2.0, use a find and replace
	 * to change 'brianzotoole2-0' to the name of your theme in all the template files.
	 */
...
function brianzotoole2_0_scripts() {
	wp_enqueue_style( 'brianzotoole2-0-style', get_stylesheet_uri() );
